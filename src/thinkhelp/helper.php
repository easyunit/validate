...
use thinkphp\App;
use thinkphp\Container;
use thinkphp\exception\HttpException;
use thinkphp\exception\HttpResponseException;
use thinkphp\facade\Cache;
use thinkphp\facade\Config;
use thinkphp\facade\Cookie;
use thinkphp\facade\Env;
use thinkphp\facade\Event;
use thinkphp\facade\Lang;
use thinkphp\facade\Log;
use thinkphp\facade\Request;
use thinkphp\facade\Route;
use thinkphp\facade\Session;
use thinkphp\Response;
use thinkphp\response\File;
use thinkphp\response\Json;
use thinkphp\response\Jsonp;
use thinkphp\response\Redirect;
use thinkphp\response\View;
use thinkphp\response\Xml;
use thinkphp\route\Url as UrlBuild;
