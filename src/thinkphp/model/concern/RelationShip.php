...
namespace thinkphp\model\concern;

use Closure;
use thinkphp\Collection;
use thinkphp\db\BaseQuery as Query;
use thinkphp\db\exception\DbException as Exception;
use thinkphp\helper\Str;
use thinkphp\Model;
use thinkphp\model\Relation;
use thinkphp\model\relation\BelongsTo;
use thinkphp\model\relation\BelongsToMany;
use thinkphp\model\relation\HasMany;
use thinkphp\model\relation\HasManyThrough;
use thinkphp\model\relation\HasOne;
use thinkphp\model\relation\HasOneThrough;
use thinkphp\model\relation\MorphMany;
use thinkphp\model\relation\MorphOne;
use thinkphp\model\relation\MorphTo;
use thinkphp\model\relation\MorphToMany;
use thinkphp\model\relation\OneToOne;
