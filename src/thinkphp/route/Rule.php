...
namespace thinkphp\route;

use Closure;
use thinkphp\Container;
use thinkphp\middleware\AllowCrossDomain;
use thinkphp\middleware\CheckRequestCache;
use thinkphp\middleware\FormTokenCheck;
use thinkphp\Request;
use thinkphp\Response;
use thinkphp\Route;
use thinkphp\route\dispatch\Callback as CallbackDispatch;
use thinkphp\route\dispatch\Controller as ControllerDispatch;
use thinkphp\route\dispatch\Redirect as RedirectDispatch;
use thinkphp\route\dispatch\Response as ResponseDispatch;
use thinkphp\route\dispatch\View as ViewDispatch;
