...
namespace thinkphp\db\connector;
...
use thinkphp\db\BaseQuery;
use thinkphp\db\builder\Mongo as Builder;
use thinkphp\db\Connection;
use thinkphp\db\ConnectionInterface;
use thinkphp\db\exception\DbException as Exception;
use thinkphp\db\Mongo as Query;
