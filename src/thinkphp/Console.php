...
use thinkphp\console\command\Clear;
use thinkphp\console\command\Help;
use thinkphp\console\command\Help as HelpCommand;
use thinkphp\console\command\Lists;
use thinkphp\console\command\make\Command as MakeCommand;
use thinkphp\console\command\make\Controller;
use thinkphp\console\command\make\Event;
use thinkphp\console\command\make\Listener;
use thinkphp\console\command\make\Middleware;
use thinkphp\console\command\make\Model;
use thinkphp\console\command\make\Service;
use thinkphp\console\command\make\Subscribe;
use thinkphp\console\command\make\Validate;
use thinkphp\console\command\optimize\Route;
use thinkphp\console\command\optimize\Schema;
use thinkphp\console\command\RouteList;
use thinkphp\console\command\RunServer;
use thinkphp\console\command\ServiceDiscover;
use thinkphp\console\command\VendorPublish;
use thinkphp\console\command\Version;
use thinkphp\console\Input;
use thinkphp\console\input\Argument as InputArgument;
use thinkphp\console\input\Definition as InputDefinition;
use thinkphp\console\input\Option as InputOption;
use thinkphp\console\Output;
use thinkphp\console\output\driver\Buffer;
